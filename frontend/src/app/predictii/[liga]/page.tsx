...
const LEAGUES: Record<string, {
  ...
  'la-liga': {
    ...
    acc70: 68.0,
    picks65: 36,
    description: 'Predicții La Liga bazate pe model XGBoost cu 110 variabile: Elo, xG, forme recente și cote Pinnacle. Acuratețe validată out-of-sample pe picks cu confidence ≥65%.',
