...
export const metadata: Metadata = {
  ...
  description: 'Cum funcționează Oxiano: model XGBoost antrenat pe 225.000 meciuri, 110 variabile, Elo ratings, xG și inteligență de piață Pinnacle. Acuratețe 62–67% pe picks cu confidence ≥65%.',
  keywords: [
  ...
  openGraph: {
    ...
    description: '225.000 meciuri de antrenament · 110 variabile · 62–67% acuratețe pe picks ≥65% conf.',
